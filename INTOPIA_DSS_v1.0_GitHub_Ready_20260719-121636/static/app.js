...
async function initialize() {
  bindNavigation(); bindSettingsAndQuarter(); bindFiles(); bindFinance(); bindReportsAndResearch(); bindSimulation(); bindEconomics(); bindAgent(); bindDecisionLog(); bindBackup(); bindRules();
